...
if __name__ == '__main__':
    ...
    path_publisher = rospy.Publisher('/cartesian_dmp_path', PoseArray, queue_size=1)
    ...
    Y[:, 0] = np.linspace(0.3, -0.3, samples)
    Y[:, 1] = 0.47
    ...
    path_publisher.publish(waypoints)